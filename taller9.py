...
def eliminarEmpleado(dicEmpleados):
    print("\n\n*** 4. Eliminar empleado\n")
    id = leerIDEmpl()
    if buscarEmpleado(dicEmpleados, id) == False:
        print("El empleado no existe en el diccionario")
        input()
    else:
        del dicEmpleados[id]
        print("El empleado fue borrado exitosamente")
        input()
        return

def listarEmpleado(dicEmpleados):

i=0
for k in listarEmpleado.items():
    i +=1
